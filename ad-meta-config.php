...
<div id="kc_ad_display_settings" class="kc_ad_settings_panel">
	...
	<p>
		<input type="radio" name="kc_ad_appear_type" value="trigger" id="kc_ad_appear_type_trigger"<?php if ($kc_ad_appear_type == 'trigger'){ echo ' checked="checked"'; } ?> /> <label for="kc_ad_appear_type_trigger">Appear at shortcode trigger<br /><span class="note">Use <code>[kittycatfish_trigger]</code> in your content.</span></label>
	</p>
